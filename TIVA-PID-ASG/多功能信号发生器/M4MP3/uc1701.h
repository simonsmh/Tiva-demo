...
//#define BUILT_IN_SIMSUN

//#define UC1701_USE_DMA
...
#define LCD_PIN_SPI_PORT            SSI2_BASE
#else // USE_DY_PB_1
// BKL  : PA5   : the screen back light
// CS   : PB2   : CS0
// CD   : PD2   : CD=0, command; CD=1, data
// RESET: PE0   : 

//#define LCD_PERIPH_BKL              SYSCTL_PERIPH_GPIOA
#define LCD_PERIPH_SPI_CS           SYSCTL_PERIPH_GPIOB
#define LCD_PERIPH_CD               SYSCTL_PERIPH_GPIOD
#define LCD_PERIPH_RESET            SYSCTL_PERIPH_GPIOE

//#define LCD_GPIO_BKL                GPIO_PORTA_BASE
